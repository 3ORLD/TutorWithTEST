...
public class Program
{
    ...
    public static void WriteStatisticsToFile(Statistics stats)
    {
    ...
    public static void DealThreeCards(Statistics stats)
    {
           Pack pack = new Pack();
    ...
    public static void DealFiveCards(Statistics stats)
    {
        Pack pack = new Pack();
        Card card1 = pack.DrawCard();
        Card card2 = pack.DrawCard();
    ...
    public static double CalculateBODMASAnswer(int value1, int value2, int value3, char operatorChar1, char operatorChar2)
    {
    ...
    public static char GetOperatorFromSuit(int suit)
    {
        return suit switch
        {
            1 => '+',
    ...
    public static double CalculateAnswer(int value1, int value2, char operatorChar)
    {
