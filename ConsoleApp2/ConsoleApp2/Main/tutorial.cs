...
namespace Jesses_Tutor.Main
{
    public static class Tutorial
    {
        public static void ShowInstructions()
        {
            ...
            Console.WriteLine("Disclaimer: You can use a calculator to work out the answer");
            Console.WriteLine("1. To begin with choose the 'Deal 3 cards' option to generate a math problem with 2 numbers and 1 Math Signs.");
